...
// const updateFormCard = ({ formOpen, setFormOpen }) => {
//     const {id} = useParams()
...
//     useEffect(() => {
//         const decryptedIds = DecryptID(encryptedId)
...
//                     <h2 className="capitalize font-bold font-inter text-3xl mt-5">New Data {refer}</h2>
//                 </div>
