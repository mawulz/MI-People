...
function userProfile() {
    ...
    return (
        ...
        <Navbar title={'Profile'}/>
            <div className="mx-12 p-12 pt-24 grid grid-cols-6 grid-rows-3 border border-t-0">
                <div className="col-span-2 col-start-2 place-items-center">
                    <div className="grid bg-slate-100 gap-4 place-items-center py-8 border w-80">
                        <img src={ProfileIcon} alt="" style={{ minWidth: '100px' }}/>
                        <div className='grid place-items-center'>
                            <h2 className="capitalize font-bold text-lg">{user.name || 'N/A'}</h2>
